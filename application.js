...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'application.data';
      var REMOTE_PACKAGE_BASE = 'application.data';
...
Module['FS_createPath']("/src", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_application.data');

      };
      Module['addRunDependency']('datafile_application.data');
    ...
    loadPackage({"files": [{"filename": "/Resources/DroidSansMono.ttf", "start": 0, "end": 119380}, {"filename": "/Resources/bpdots.squares-bold.ttf", "start": 119380, "end": 159172}, {"filename": "/src/shaders/blurShader.frag", "start": 159172, "end": 160775}, {"filename": "/src/shaders/fluidShader.frag", "start": 160775, "end": 163848}, {"filename": "/src/shaders/isometric.frag", "start": 163848, "end": 170860}, {"filename": "/src/shaders/isometric.vert", "start": 170860, "end": 171138}, {"filename": "/src/shaders/shader.vert", "start": 171138, "end": 171367}], "remote_package_size": 171367});
...
var ASM_CONSTS = {
  1149904: () => { Water.checked = true; },  
 1149926: () => { Sand.checked = true; },  
 1149947: () => { Stone.checked = true; },  
 1149969: ($0, $1) => { toolAmountAmount.value = $0; toolAmountSlider.value = $0; toolRadiusAmount.value = $1; toolRadiusSlider.value = $1; },  
 1150089: () => { Stone.checked = true; },  
 1150111: () => { Sand.checked = true; },  
 1150132: () => { Water.checked = true; },  
 1150154: () => { Lava.checked = true; },  
 1150175: () => { Mist.checked = true; },  
 1150196: () => { Foam.checked = true; },  
 1150217: ($0) => { toolAmountAmount.value = $0; toolAmountSlider.value = $0; },  
 1150279: ($0) => { toolRadiusAmount.value = $0; toolRadiusSlider.value = $0; },  
 1150341: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL); },  
 1150566: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 1150713: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 1150947: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0; },  
 1151440: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
 ...
 1153160: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']); },  
 1153570: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } } },  
 1154175: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } } },  
 1154655: ($0) => { var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; } },  
 1155827: ($0, $1, $2) => { var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); SDL2.data32Data = data; } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); },  
 1157296: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 1158285: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 1158368: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 1158437: () => { return window.innerWidth; },  
 1158467: () => { return window.innerHeight; }
};
...
/** @type {function(...*):?} */
var _selectToolStone = Module["_selectToolStone"] = createExportWrapper("selectToolStone");
/** @type {function(...*):?} */
var _selectToolSand = Module["_selectToolSand"] = createExportWrapper("selectToolSand");
/** @type {function(...*):?} */
var _selectToolWater = Module["_selectToolWater"] = createExportWrapper("selectToolWater");
/** @type {function(...*):?} */
var _selectToolLava = Module["_selectToolLava"] = createExportWrapper("selectToolLava");
/** @type {function(...*):?} */
var _selectToolMist = Module["_selectToolMist"] = createExportWrapper("selectToolMist");
/** @type {function(...*):?} */
var _selectToolFoam = Module["_selectToolFoam"] = createExportWrapper("selectToolFoam");
/** @type {function(...*):?} */
var _changeToolRadius = Module["_changeToolRadius"] = createExportWrapper("changeToolRadius");
/** @type {function(...*):?} */
var _changeToolAmount = Module["_changeToolAmount"] = createExportWrapper("changeToolAmount");
/** @type {function(...*):?} */
var _changeMapGenDetail = Module["_changeMapGenDetail"] = createExportWrapper("changeMapGenDetail");
/** @type {function(...*):?} */
var _changeSandHeight = Module["_changeSandHeight"] = createExportWrapper("changeSandHeight");
/** @type {function(...*):?} */
var _generateMap = Module["_generateMap"] = createExportWrapper("generateMap");
/** @type {function(...*):?} */
var _setAutoGenerate = Module["_setAutoGenerate"] = createExportWrapper("setAutoGenerate");
/** @type {function(...*):?} */
var _setmapGenX = Module["_setmapGenX"] = createExportWrapper("setmapGenX");
/** @type {function(...*):?} */
var _setmapGenY = Module["_setmapGenY"] = createExportWrapper("setmapGenY");
/** @type {function(...*):?} */
...
// include: C:\Users\dwtys\emsdk\upstream\emscripten\src\emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: C:\Users\dwtys\emsdk\upstream\emscripten\src\emrun_postjs.js
